    ...
    return (
        <div className="mt-10 sm:mt-20 ">
            {categories.map(({ icon: Icon, label }) => (
                <div
                    key={label}
                    className="m-1 py-2 px-3 inline-flex items-center gap-x-2 font-medium rounded-lg border-gray-200 border text-white shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none bg-neutral-900" >
                    <Icon size={40} />
